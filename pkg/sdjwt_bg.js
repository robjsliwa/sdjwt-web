 ...
 * @returns {string}
 */
export function wasm_encode(header, key, payload) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        wasm.wasm_encode(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
...
const SdJwtHolderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sdjwtholder_free(ptr >>> 0, 1));
...
export class SdJwtHolder {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SdJwtHolderFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sdjwtholder_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.sdjwtholder_new();
        this.__wbg_ptr = ret >>> 0;
        SdJwtHolderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {any}
     */
    verify(encoded_issuer_jwt, public_key, algorithm) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(encoded_issuer_jwt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            const len2 = WASM_VECTOR_LEN;
            wasm.sdjwtholder_verify(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     * @returns {string}
     */
    presentation(encoded_issuer_jwt, redacted_paths) {
        let deferred4_0;
        let deferred4_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(encoded_issuer_jwt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArrayJsValueToWasm0(redacted_paths, wasm.__wbindgen_malloc);
            const len1 = WASM_VECTOR_LEN;
            wasm.sdjwtholder_presentation(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
const SdJwtIssuerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sdjwtissuer_free(ptr >>> 0, 1));
...
export class SdJwtIssuer {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SdJwtIssuerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sdjwtissuer_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.sdjwtholder_new();
        this.__wbg_ptr = ret >>> 0;
        SdJwtIssuerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} claims
     ...
     * @returns {string}
     */
    encode(claims, signing_key, algorithm) {
        let deferred5_0;
        let deferred5_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(claims, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(signing_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(algorithm, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            wasm.sdjwtissuer_encode(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
const SdJwtVerifierFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sdjwtverifier_free(ptr >>> 0, 1));
...
export class SdJwtVerifier {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SdJwtVerifierFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sdjwtverifier_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.sdjwtholder_new();
        this.__wbg_ptr = ret >>> 0;
        SdJwtVerifierFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {any}
     */
    verify(holder_presentation_sdjwt, public_key, algorithm) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(holder_presentation_sdjwt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(public_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(algorithm, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            wasm.sdjwtverifier_verify(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
export const __wbg_now_ade76a1f39693a38 = typeof Date.now == 'function' ? Date.now : notDefined('Date.now');
